    ...
    <section className="flex w-full border-x-2 border-black md:flex-col">
      ...
      <div className="flex w-full md:flex-col ">
        {rooms.map(({ name, session: { id, title, startsAt, endsAt, speakers, description } }) => {
          ...
          return (
            <article
              className="max-w-1/2 flex w-full flex-col items-center justify-center border-l-2 border-t-2 border-black px-7 pb-8 pt-7 transition-colors duration-200 hover:bg-primary-yellow md:border-l-0 md:px-4 md:py-7"
              key={id}
            >
