...
import drop1Image from '../summit-2024/hero/images/drop-1.jpg';
import drop2Image from '../summit-2024/hero/images/drop-2.jpg';
import honeyImage from '../summit-2024/hero/images/honey.jpg';
import defaultIllustration from '../summit-2024/hero/images/illustration.svg';
...
const Hero = ({
  ...
  <section className={`relative lg:overflow-hidden ${rootClassName || ''}`}>
    <div className="absolute -top-20 right-0 -z-10 w-[200px] lg:block md:-right-4 sm:-top-[120px] sm:hidden">
      <StaticImage src={drop1Image} alt="" loading="eager" aria-hidden />
    </div>
    <div className="absolute -top-3 left-0 -z-10 w-[128px] 2xl:-left-4 2xl:top-12 xl:-left-8 lg:-top-3 md:-left-4 sm:-left-14 sm:-top-[28px] sm:hidden">
      <StaticImage src={drop2Image} alt="" loading="eager" aria-hidden />
    </div>
    <div className="absolute -left-10 top-96  -z-10 w-[330px] 2xl:-left-20 2xl:top-[450px] 2xl:w-[280px] lg:left-0 lg:top-80 lg:block md:-left-20 md:top-64 sm:hidden">
      <StaticImage src={honeyImage} alt="" loading="eager" aria-hidden />
    </div>
    <div className="container relative pt-28 lg:w-[95%] lg:pt-16 md:pt-8 ">
      <div className="flex max-w-[644px] flex-col lg:max-w-full lg:text-center">
        ...
        />
        <div className="relative z-10 mt-9 flex space-x-5 lg:justify-center sm:flex-col sm:space-x-0 sm:space-y-3 xs:w-full">
      ...
      <img
        ...
        className="absolute right-8 top-32 h-auto w-[520px] z-0 lg:static lg:mt-12 lg:w-[80%] lg:max-w-[520px]"
        alt="Illustration"
        width={624}
        height={404}
        loading="eager"
