...
const SummitHeader = ({ navigation, devpostUrl }) => {
  const closeMenu = (e) => {
    e.stopPropagation();
  };
  return (
              ...
              >
                <div className="ring-gray-900 overflow-hidden rounded-lg bg-white shadow-md ring-1 ring-opacity-5">
                  <div className="flex items-center justify-between px-5 pt-4">
                    ...
                    <div className="-mr-2">
                      <Popover.Button
                        className="hover:text-gray-5 hover:bg-gray-100 focus-visible:ring-outline inline-flex items-center justify-center rounded-md bg-white p-2 text-black focus:outline-none focus-visible:ring-2"
                        onClick={closeMenu}
                      >
