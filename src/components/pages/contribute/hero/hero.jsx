    ...
    <section className="hero safe-paddings mt-20 lg:mt-16 md:mt-12">
      <div className="container">
        <div className="mx-auto max-w-[790px] text-center">
          <h1 className="heading-10xl font-semibold leading-tight">{t('hero.title')}</h1>
          ...
          >
            ...
            <div className="mt-4 text-sm">
              ...
              <ul className="mt-2.5 inline-flex space-x-6 xs:flex-col xs:space-x-0 xs:space-y-2">
                {t('hero.card.authors', { returnObjects: true }).map(({ name, company }, index) => (
                  <li
              ...
              <p className="mt-2.5">{t('hero.card.secondDescription')}</p>
              <ul className="mt-6 flex flex-wrap gap-x-5 gap-y-4">
                {t('hero.card.links', { returnObjects: true }).map(({ text, to }, index) => (
                  <li
