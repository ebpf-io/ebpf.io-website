      ...
      {items.map(({ title, logo: Logo, description, links }, index) => (
        <li
          className={clsx(
            ...
            '[&:nth-child(-n+3)]:border-t-0 [&:nth-child(3n+1)]:border-l-0',
            'md:[&:nth-child(-n+2)]:border-t-0 md:[&:nth-child(-n+3)]:border-t md:[&:nth-child(2n+1)]:border-l-0 md:[&:nth-child(3n+1)]:border-l',
            'sm:!border-t sm:border-l-0 sm:px-0 sm:first:!border-t-0 sm:first:pt-0 sm:last:pb-0 sm:[&:nth-child(3n+1)]:border-l-0'
          )}
          key={index}
        >
          ...
          <p
            className="mb-7 mt-6 text-lg lg:mb-5 lg:text-base [&_strong]:font-semibold"
