...
const pageMetaDescription = 'Registration is now open for the eBPF Summit 2021, a virtual event, targeted at DevOps, SecOps, platform architects, and developers. To be held August 18-19, 2021.'
...
const Registration = () => (
  <div className="summit-about">
    <div className="wrapper" style={{textAlign: 'center'}}>
      <a name="register" />
      <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSeVuoYbf2cSlczAxGT9S9Cm7w0Yb8W9ALAiKADf5HLe7MjXKQ/viewform?embedded=true" width="640" height="543" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
    </div>
  </div>
);
