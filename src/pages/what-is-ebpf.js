    ...
    return (
      <React.Fragment>
        ...
        <div className="what-is-ebpf-description" ref="content">
          ...
          <h2>What is eBPF?</h2>
    <p>
      eBPF (which is no longer an acronym for anything), sometimes referred to simply as "BPF", is a revolutionary technology with origins in the Linux kernel that can run sandboxed programs in a privileged context such as an operating system kernel. It is used to safely and efficiently extend the capabilities of the kernel without requiring to change kernel source code or load kernel modules.
    </p>
    <p>
