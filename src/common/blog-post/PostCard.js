...
const PostCard = ({ post }) => {
  ...
  const { previewHtml, previewDescription } = parseHtml(post);
    ...
    <div className='blog-post-card' key={post.id}>
      {post.frontmatter.ogImage && (
        <img
          ...
          src={post.frontmatter.ogImage.publicURL}
          width='300'
          height='220'
        />
      )}
      ...
      <div className='blog-post-card-content'>
        ...
        <div
          className='blog-post-card-description'
          ...
          <div className='blog-categories-and-date'>
            ...
            {categories.length > 0 && (
              <div className='blog-post-categories'>
                ...
                {url && <span className='blog-post-category'>External</span>}
              </div>
            )}
          </div>
        </div>
